...
export class FolderResolver {
  ...
  async resolveFolderToId(folderNameOrId) {
    ...
    // Handle Microsoft Graph well-known folder names
    const wellKnownFolders = new Set(['inbox', 'sentitems', 'drafts', 'deleteditems', 'junkemail', 'archive']);
    if (wellKnownFolders.has(folderNameOrId.toLowerCase())) {
      return folderNameOrId.toLowerCase();
    }
